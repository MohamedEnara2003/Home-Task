...
import { NavigationsService } from '../../../../core/service/navigations/navigations.service';
...
@Component({
  ...
  <span [id]="'Icon-' + link.id" class="md:hidden">
  @switch (link.id) {
  @case (1) {
...
readonly navService = inject(NavigationsService);
